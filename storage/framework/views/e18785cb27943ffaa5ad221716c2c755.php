    ...
    <div class="container-menu">
        <div class="cont-menu">
            <nav>
                ...
                <a href="<?php echo e(route('iniciarsesion')); ?>" class="btn btn-outline-danger">Iniciar sesión</a>
                <a href="<?php echo e(route('registro')); ?>" class="btn btn-outline-danger">Registrarse</a>
...
<?php /**PATH C:\laragon\www\opina\opina\resources\views/layouts/navbarsinsesion.blade.php ENDPATH**/ ?>