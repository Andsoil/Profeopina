    ...
    <div class="container">
        ...
        <div class="profesor-perfil">
            ...
            <div class="botones">
                ...
                <a href="<?php echo e(route('iniciarsesion')); ?>" class="boton">Añadir reseña</a>
            </div>
            <!-- Quinta Parte: Enlace -->
...
<?php echo $__env->make('layouts.navbarsinsesion', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\opina\opina\resources\views/perfil_profe.blade.php ENDPATH**/ ?>